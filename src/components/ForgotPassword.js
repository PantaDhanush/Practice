  ...
  return (
    <div className='container-fluid mt-3 text-center'>
      <form className="row justify-content-center flex-column align-items-center"action="">
            ...
            <div className="form-group form-floating col-8 col-lg-7 my-2">
                <i class="bi bi-person-fill bi-lg"></i>
            ...
            <div className="form-group form-floating col-8 col-lg-7 my-2">
                ...
                <input type="text" className="form-control"id='UserRegNo'placeholder="Enter Student Registration Number" required/>                    
            ...
            <button type="submit" className="btn btn-primary col-lg-3 col-4 my-4">Update Password</button>
      </form>
    </div>
  )
}
